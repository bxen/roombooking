...
import 'package:roombooking/services/api_client.dart';
import 'package:roombooking/services/session.dart';
import 'package:intl/intl.dart'; // ✅ เพิ่มบรรทัดนี้
...
class _StdstatusPageState extends State<StdstatusPage> {
  ...
  String _fmtDate(String raw) {
    try {
      ...
      return DateFormat('d MMM yyyy').format(date); // แสดงเป็น 6 Nov 2025
    } catch (_) {
      return raw;
    }
  }
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          ...
          textAlign: TextAlign.center,
          style:
              GoogleFonts.alice(fontWeight: FontWeight.bold, fontSize: 18),
        ),
        content: Text(
          'This action cannot be undone.',
          textAlign: TextAlign.center,
